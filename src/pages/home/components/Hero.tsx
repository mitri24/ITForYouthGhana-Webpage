...
const Hero: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Contact Buttons positioned outside hero section for desktop, inside for mobile */}
      <div 
      ...
      <style jsx>{`
        ...
        @media (min-width: 769px) {
          ...
          /* Desktop: Normale Buttons mit Text - außerhalb der section */
          .contact-buttons {
        ...
        @media (max-width: 768px) {
          .mobile-hero-design {
            clip-path: none;
            border-radius: 0;
            height: 100vh !important; /* Volle Bildschirmhöhe auf Mobile */
          }
