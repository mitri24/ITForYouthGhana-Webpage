<template>
  <section class="hero homepage gpu-accelerated">
    <div class="hero-container">
      <div class="hero-content optimize-text">
        <h1 class="hero-title will-change-opacity">
          Empowering Youth Through Technology
        </h1>
        
        <p class="hero-subtitle will-change-opacity">
          Building digital skills for Ghana's next generation of tech leaders
        </p>
