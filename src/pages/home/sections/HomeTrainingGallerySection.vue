<template>
  <section class="impact-showcase homepage gpu-accelerated">
      ...
      <div class="showcase-grid">
        ...
        <div class="cta-panel">
          <div class="cta-content">
            ...
            <h3 class="will-change-opacity">Your Future Starts Here</h3>
            <p class="cta-highlight will-change-opacity">Join 1000+ students who transformed their lives</p>
            <p class="cta-description will-change-opacity">Get industry-ready skills, mentorship, and job placement support</p>
        ...
        <!-- Featured Story -->
        <div class="featured-story will-change-transform">
          <div class="story-image">
            <img :src="successStories[currentStory].image" :alt="successStories[currentStory].name" loading="lazy" decoding="async" />
            <div class="story-badge">{{ successStories[currentStory].badge }}</div>
            <div class="story-overlay">
              <div class="story-info">
                <h3 class="will-change-opacity">{{ successStories[currentStory].name }}</h3>
                <p class="role will-change-opacity">{{ successStories[currentStory].role }}</p>
              </div>
            </div>
          </div>
          
          <div class="story-quote will-change-opacity">
...
.section-title {
  ...
  line-height: 1.1;
  background: linear-gradient(135deg, #030b14 0%, #195aa5 100%);
