...
const NgoAndFoundationPartnerships: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="NGO & Foundation Partnerships - IT for Youth Ghana"
        description="Collaborate with other NGOs and foundations to maximize impact and share resources."
        canonical="/partnerships/ngo-and-foundation-partnerships"
      />
      ...
      <div className="min-h-screen">
        <Hero
          ...
          secondaryCta={{ text: "Download Collaboration Guide", action: () => window.location.href = '/contact' }}
        />
            ...
            >
              ...
              >
                ...
                <p className="text-lead mb-8 text-neutral-700">
                  Join forces with us to amplify impact and create lasting change in Ghana's digital landscape.
                </p>
...
export default NgoAndFoundationPartnerships