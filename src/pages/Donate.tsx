...
const Donate: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      ...
      <section id="donation-methods" className="py-20 bg-white">
        <div className="container">
                ...
                <div className="space-y-4">
                  {method.details.map((detail, idx) => (
                    <div key={idx} className="flex justify-between items-center py-2 border-b border-secondary/10">
                      <span className="font-semibold text-neutral-700">{detail.label}:</span>
          ...
          >
            ...
            <h3 className="text-3xl font-bold mb-4">Card Payment</h3>
      ...
      {/* Call to Action */}
      <section className="py-20 bg-ngo-gradient">
        <div className="container">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            ...
            className="text-center text-white"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Every Contribution Makes a Difference</h2>
