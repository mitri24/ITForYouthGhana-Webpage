// SEO-optimized content for IT for Youth Ghana
export const content = {
  seo: {
    keywords: "IT education Ghana, youth tech training, digital skills Ghana, coding bootcamp Accra, women in tech Ghana, programming course Ghana, tech empowerment Africa",
    description: "IT for Youth Ghana empowers underserved youth with essential technology skills. Free coding, data analytics & digital training programs. 40% female participation. Transform your future today!",
    title: "IT for Youth Ghana | Tech Education & Digital Skills Training for Youth"
  },
  ...
  programs: {
    main: [
      ...
      },
      {
        ...
        subtitle: "2-Month Specialized Program",
        ...
        highlights: ["Small cohort of 10-12 students", "International perspective from German partnership", "21 practical assignments", "One-on-one portfolio reviews"],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "You need basic English reading and writing skills, commitment to attend classes regularly for 6 months, and genuine interest in learning technology. We don't require previous computer experience - we'll teach you everything you need to know."
    },
    {
      question: "How do you help with finding jobs after graduation?",
      answer: "We provide resume assistance, interview practice, and introductions to employers in our network. However, we can't guarantee jobs - success depends on your effort during the program and job search. Most graduates find work within 6 months, but it takes persistence."
    },
    {
      question: "Can I join if I'm from outside Accra?",
      answer: "Our main programs are in-person in Accra, but we occasionally run workshops in other regions. We're working on online options but currently believe hands-on, in-person learning is most effective for our students."
    },
    {
      question: "What if I don't complete the program?",
      answer: "Life happens, and we understand that not everyone can complete the full 6 months. We work with students facing challenges, but if you need to leave, you're welcome to apply for future cohorts when your situation improves."
    },
    {
      question: "How competitive is the application process?",
      answer: "We have limited space (15-20 students per program), so we do have to select among applicants. We prioritize motivation and commitment over previous experience. Having clear goals and demonstrating dedication during the application process helps."
    }
  ]
}