...
const FooterSocial: React.FC = () => {
  const socialLinks: SocialLink[] = [
    { 
      name: 'Facebook', 
      href: 'https://www.facebook.com/itforyouthghanacollege/',
      icon: (
    ...
    { 
      name: 'Instagram', 
      href: 'https://www.instagram.com/itforyouthghana/?hl=de',
      icon: (
        <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
    ...
    { 
      name: 'LinkedIn', 
      href: 'https://gh.linkedin.com/company/it-for-youth-ghana-foundation',
      icon: (
        <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
    ...
    { 
      name: 'YouTube', 
      href: 'https://www.youtube.com/@ITforYouthGhana',
      icon: (
        <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
    ...
    { 
      name: 'X', 
      href: 'https://x.com/ITFORYOUTHGHANA',
      icon: (
        <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
